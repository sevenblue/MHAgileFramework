...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [NSTimer scheduledTimerWithTimeInterval:2 target:self selector:@selector(autoChangeCurrentPage:) userInfo:nil repeats:YES];
       
    }
    return self;
}

- (void)autoChangeCurrentPage:(id)sender{
